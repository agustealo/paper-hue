/* Rainbow v2.1.4 rainbowco.de | included languages: c, coffeescript, csharp, css, d, generic, go, haskell, html, java, javascript, json, lua, php, python, r, ruby, scheme, shell, smalltalk, sql */ !(function(
  e,
  t
) {
  ...
  function c(t, Prism) {
    ...
    var l = c + "\tthis.onmessage=" + t.toString(),
      f = new Blob([l], { type: "text/javascript" });
  ...
  function g(e, t, n) {
    return function(r) {
      (e.innerHTML = r.result),
        ...
        e.classList.add("rainbow-show"),
        "PRE" === e.parentNode.tagName &&
          (e.parentNode.classList.remove("loading"),
          e.parentNode.classList.add("rainbow-show")),
        M && M(e, r.lang),
        0 === --t.c && n();
    };
  }
  ...
  function p(e, t) {
    for (var r = { c: 0 }, a = 0, o = e; a < o.length; a += 1) {
      ...
      if (!i.classList.contains("rainbow") && s) {
        ...
        ++r.c,
          d(
            v(i.innerHTML, { language: s, globalClass: u, delay: c }),
            g(i, r, t)
          );
      }
    }
  ...
  function b(e, t) {
    ...
    for (
      ...
      var u = s[i];
      h(u),
        u.getElementsByTagName("code").length
          ? u.getAttribute("data-trimmed") ||
            (u.setAttribute("data-trimmed", !0),
            (u.innerHTML = u.innerHTML.trim()))
          : a.push(u);
    }
  ...
  var M,
    Prism = function Prism(e) {
      ...
      function f(r, a, i) {
        function c(e) {
          return (
            r.name && (e = n(r.name, e)),
            (p[w] = { replace: m[0], with: e }),
            (h[w] = y),
            !g && { remaining: a.substr(y - i), offset: y }
          );
        }
        function f(t) {
          var a = m[t];
          if (a) {
            ...
            (f = d.refract(a, v, c.length ? c : [c])),
              l(a, f, i.matches ? i.name : 0);
          }
        }
        void 0 === i && (i = 0);
        var d = r.pattern;
    ...
    k = t(),
    j = null;
  (x = { extend: y, remove: L, onHighlight: w, addAlias: E, color: N }),
    R &&
